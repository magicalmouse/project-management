...
async function setupDatabase() {
	try {
		...
		// Create tables manually to avoid prepared statement issues
		...
		await connection.query(createProposalsTable);
		console.log("✅ Proposals table created!");

		await connection.query(createInterviewsTable);
		console.log("✅ Interviews table created!");

		await connection.query(createSavedResumesTable);
		console.log("✅ Saved resumes table created!");
